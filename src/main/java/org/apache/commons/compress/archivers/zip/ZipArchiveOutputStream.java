...
public class ZipArchiveOutputStream extends ArchiveOutputStream<ZipArchiveEntry> {
    ...
    public static final class Builder {
        ...
        /**
         * @see ZipArchiveOutputStream#setComment(String)
         */
        ...
        /**
         * @see ZipArchiveOutputStream#setCreateUnicodeExtraFields(UnicodeExtraFieldPolicy)
         */
        ...
        /**
         * @see ZipArchiveOutputStream#setEncoding(String)
         */
        ...
        /**
         * @see ZipArchiveOutputStream#setFallbackToUTF8(boolean)
         */
        ...
        /**
         * @see ZipArchiveOutputStream#setUseLanguageEncodingFlag(boolean)
         */
        ...
        /**
         * @see ZipArchiveOutputStream#setLevel(int)
         */
        ...
        /**
         * @see ZipArchiveOutputStream#setMethod(int)
         */
        ...
        /**
         * @see ZipArchiveOutputStream#setUseZip64(Zip64Mode)
         */
    ...
    private boolean usesDataDescriptor(final int zipMethod, final boolean phased) {
        if (!phased && !(out instanceof RandomAccessOutputStream)) {
            if (hasCompressionPayloadWriterFactory(zipMethod) || ZipMethod.isZstd(zipMethod)) {
                return false;
            }
        }
        return !phased && !(out instanceof RandomAccessOutputStream) && zipMethod == DEFLATED;
    }
